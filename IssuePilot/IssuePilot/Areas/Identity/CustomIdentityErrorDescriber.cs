...
namespace IssuePilot.Areas.Identity
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        // Code von https://stackoverflow.com/questions/19961648/how-to-localize-asp-net-identity-username-and-password-error-messages
